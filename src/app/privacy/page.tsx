  ...
  return (
    <div className={styles.privacy_policy}>
      ...
      <section>
        <h2>プライバシーポリシー</h2>
        <p>
          tacto株式会社（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
        </p>
        ...
        <h2>第9条（安全管理措置）</h2>
        <p>
          当社は、その取り扱う個人情報の漏洩、滅失又は毀損の防止その他個人情報の安全管理のために、必用かつ適切な措置を講じます。
        </p>
        ...
        <p>
          ...
          <br />
          住所：東京都品川区上大崎4-5-28 MEGUROHAUS601
          <br />
          社名：tacto株式会社
          <br />
          代表取締役：中島 琢郎
          <br />
          メールアドレス：hello@tacto-inc.com
        </p>
      </section>
    </div>
  );
